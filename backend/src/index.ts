...
import opportunityDocsRouter from './routes/opportunityDocs';
...
import productTaxonomyRouter from './routes/productTaxonomy';
...
app.use('/api/opportunity-docs', opportunityDocsRouter);
app.use('/api/sales-settings', salesSettingsRouter);
...
app.use('/api/product-taxonomy', productTaxonomyRouter);
