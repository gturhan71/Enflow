...
export const DEFAULT_UNITS: { key: string; name: string; description: string }[] = [
  ...
  { key: 'igpd', name: 'İGB — İş Geliştirme Birimi', description: 'Fırsat programı yönetimi, ziyaret planı ve onay takibi.' },
...
const GM_PERMISSIONS = [
  ...
  'SALES_SUPPORT_VIEW', 'CONTRACTS_VIEW', 'PROCUREMENT_VIEW', 'PROJECT_MGMT_VIEW', 'SERVICE_TICKETS_VIEW', 'FINANCE_VIEW',
  'DMO_VIEW', 'DMO_EDIT',
