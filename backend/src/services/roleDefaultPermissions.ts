...
export const ROLE_DEFAULT_PERMISSIONS: Record<string, string[]> = {
  ...
  GENERAL_MANAGER: [
    ...
    'MANAGEMENT_REPORTS_VIEW', 'CORPORATE_GOV_VIEW', 'DOCUMENTS_VIEW', 'ARCHIVE_VIEW', 'ARCHIVE_EDIT',
  ...
  SALES_MGR: ['DASHBOARD_VIEW', 'CRM_VIEW', 'CRM_OPPS_VIEW', 'CRM_PROPOSALS_VIEW', 'CRM_CUSTOMERS_VIEW', 'COST_ANALYSIS_VIEW', 'SALES_SUPPORT_VIEW', 'CONTRACTS_VIEW', 'PROCUREMENT_VIEW', 'PROJECT_MGMT_VIEW', 'DOCUMENTS_VIEW', 'TODO_VIEW', 'DMO_VIEW'],
  ...
  PROJECT_MGR: ['DASHBOARD_VIEW', 'PROJECT_MGMT_VIEW', 'SERVICE_TICKETS_VIEW', 'MANAGEMENT_REPORTS_VIEW', 'CONTRACTS_VIEW', 'DOCUMENTS_VIEW', 'TODO_VIEW'],
  ...
  FINANCE_MGR: ['DASHBOARD_VIEW', 'FINANCE_VIEW', 'MANAGEMENT_REPORTS_VIEW', 'CONTRACTS_VIEW', 'PROCUREMENT_VIEW', 'DOCUMENTS_VIEW', 'TODO_VIEW'],
