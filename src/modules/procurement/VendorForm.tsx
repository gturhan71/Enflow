    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm">
      ...
      >
        <div className="p-5 border-b border-slate-200/60 flex items-center justify-between shrink-0">
          ...
          <button onClick={onClose} className="p-2 hover:bg-slate-100 rounded-xl transition-colors text-slate-400 hover:text-slate-700"><X size={18} /></button>
        </div>
        ...
        <div className="p-5 border-t border-slate-200/60 flex justify-end gap-3 shrink-0">
