// Şirket adı benzerliği (mükerrer müşteri kaydı önerisi için). Harici bağımlılık
// eklemeden — standart Levenshtein. Bu dosya backend/src/utils/textSimilarity.ts
// ile birebir aynı tutulmalı — repo'da paylaşılan bir workspace yok.
