...
## changes (last 10 commits — 28 minutes ago)
```
...
backend/src/services/processEngine.ts         ~createProjectFromEntity  ~createContractFromTender  ~createSalesInvoiceForProject  ~walkForward
