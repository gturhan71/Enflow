...
backend/src/services/approvalChainService.ts  +resolveEffectiveApprover  +resolveGroupAfterDecision  ~resolveEffectiveApprover  ~ensureApprovalChain
backend/src/services/approvalSlaEscalation.ts +getApprovalSlaBusinessDays  +sweepApprovalSlaEscalations
backend/src/services/processEngine.ts         +ProcessNotConfiguredError  +resolveStepRecipients  +isAuthorizedForStep  +createProjectFromEntity
