...
### tests/rbac/RAPOR_SABLONU.md
```
h1 Enflow — RBAC ve Güvenlik Test Raporu
h2 1. Yönetici Özeti
h2 2. Kapsam
h2 3. API Yetki Matrisi Sonucu
h2 4. Tenant İzolasyonu (IDOR) Sonucu
h2 5. UI Erişim Sonucu
h2 6. Bulgular
h3 BUG-001 — [Başlık]
h2 7. Öneriler
h2 8. Ek: Otomatik Test Kapsamı
```

### tests/rbac/RAPOR_2026-06-14.md
```
h1 Enflow — RBAC ve Güvenlik Test Raporu
h2 1. Yönetici Özeti
h2 2. Kapsam
h2 3. API Yetki Matrisi Sonucu
h2 4. Tenant İzolasyonu Sonucu
h2 5. UI Erişim Sonucu
h2 6. Bulgular
h3 BUG-01 · KRİTİK · Tenant İzolasyonu Eksik (IDOR)
h3 BUG-02 · Yüksek · RBAC Enforcement Eksik (18 endpoint)
h3 BUG-03 · Düşük · UI Sidebar Selector Uyumsuzluğu
h3 BUG-04 · Düşük · Oturumsuz Login Testi Başarısız
h2 7. Öneriler ve Öncelik Sırası
h2 8. Ek: Test Altyapısı
```

### tests/rbac/pnpm-lock.yaml
```
keys: [lockfileVersion, settings, importers, packages, snapshots]
```

### tests/rbac/security-reporter.ts
```
class SecurityMailReporter  :176-249
onBegin  :178-178
onTestEnd  :179-179
async onEnd  :181-246
printsToStdio  :248-248
```
