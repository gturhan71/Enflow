...
> **Not everything is here.** 212 file(s) omitted to stay under the 20340-token budget (tests and configs go first). The retrieval index still has them all — run `sigmap ask "<question>"` to pull in anything missing.