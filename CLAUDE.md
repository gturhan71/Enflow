...
## changes (last 10 commits — 10 hours ago)
```
...
export async function autoSkipOrphanStages(tenantId, chainId)  :74-208  # Skip-logic: **hiçbir aktif kullanıcıya** karşılık gelmeyen P
