...
src/modules/dashboard/widgetCatalog.ts        +resolveRoleDefault  +resolveEffectiveWidgets  +buildEditableLayout  ~resolveEffectiveWidgets
src/modules/dashboard/WidgetDetailDrawer.tsx  ~Rows
