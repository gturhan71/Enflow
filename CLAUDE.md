...
- [ ] **ActivityLog kapsamı** — denetim bulgusu: ActivityLog şu an yalnızca `opportunities.ts`'te yazılıyor; diğer ~27 router'a denetim-izi/provenance yaymak (gözlemlenebilirlik boşluğu).
